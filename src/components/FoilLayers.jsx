...
export default function FoilLayers({ glareX, glareY, foilAngle, active = true, compact = false }) {
  ...
  if (compact) {
    return (
      <>
        <motion.div className="foil foil-holo-color foil-compact" style={{ background: holoColor, opacity: active ? 0.38 : 0.08 }} />
        <motion.div className="foil foil-gloss foil-compact" style={{ background: gloss, opacity: active ? 0.46 : 0.12 }} />
